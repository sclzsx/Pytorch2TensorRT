...
class BasicDwConv(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, padding=0, dilation=1, groups=1, relu=True,
        ...
        self.depthwise_conv = nn.Conv2d(in_planes, in_planes, kernel_size=kernel_size, stride=stride, padding=padding,
                                        dilation=dilation, groups=in_planes, bias=bias)
        self.pointwise_conv = nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=1)
